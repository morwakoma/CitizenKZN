    ...
    public class VacancyController : Controller
    {
        ...
        public ActionResult DownloadVacancyAd(int id)
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                PdfPCell cellBPSNo = new PdfPCell(new Phrase("Advert Reference Number:", font));
                cellBPSNo.Colspan = 1;
                ...
                //Location
                PdfPCell cellLocation = new PdfPCell(new Phrase("Center:", font));
        ...
        public ActionResult DownloadCandidateProfile(string id)
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                {
                    cellP = new PdfPCell(new Phrase("Do you have any pending criminal case against you?"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                    ...
                    cellP = new PdfPCell(new Phrase(" If yes, (provide the details):"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell(profileData.CriminalCaseDesc);
                }
                else
                {
                    cellP = new PdfPCell(new Phrase("Do you have any pending criminal case against you?"));
                ...
                {
                    cellP = new PdfPCell(new Phrase("Have you ever been dismissed for misconduct from the Public Service?"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                    ...
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell(profileData.MisconductDesc);
                }
                else
                {
                    cellP = new PdfPCell(new Phrase("Have you ever been dismissed for misconduct from the Public Service?"));
                ...
                {
                    cellP = new PdfPCell(new Phrase("Do you have any pending disciplinary case against you?"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                    ...
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell(profileData.DisciplinaryCaseDesc);
                }
                else
                {
                    cellP = new PdfPCell(new Phrase("Have you ever been dismissed for misconduct from the Public Service?"));
                ...
                {
                    cellP = new PdfPCell(new Phrase("Have you resigned from a recent job pending any disciplinary proceeding against you? If yes, (please note that the provisions of the Public Service Act shall apply)"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                }
                ...
                {
                    cellP = new PdfPCell(new Phrase("Have you been discharged or retired from the Public Service on grounds of Ill-health or on condition that your cannot be re- employed?"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                }
                ...
                {
                    cellP = new PdfPCell(new Phrase("Are you conducting business with the State or are you a Director of a Public or Private company conducting business with the State?"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                    ...
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell(profileData.BusinessDesc);
                }
                else
                {
                    cellP = new PdfPCell(new Phrase("Are you conducting business with the State or are you a Director of a Public or Private company conducting business with the State?"));
                ...
                {
                    cellP = new PdfPCell(new Phrase("In the event that you are employed in the Public Service, will you immediately relinquish such business interests?"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                }
                ...
                if (profileData.fkDisabilityID == 1)
                {
                    ...
                    cellP = new PdfPCell(new Phrase("Other Nature of Disability: "));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell(profileData.OtherNatureOfDisability);
                ...
                {
                    cellP = new PdfPCell(new Phrase("Have you been convicted or found guilty of a criminal offence (including an admission of guilt)?"));
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell("Yes");
                    ...
                    cellP.BackgroundColor = BaseColor.LIGHT_GRAY;
                    table.AddCell(cellP);
                    table.AddCell(profileData.CriminalOffenceDesc);
                }
                else
                {
                    cellP = new PdfPCell(new Phrase("Have you been convicted or found guilty of a criminal offence (including an admission of guilt)?"));
...
//vacancyID = _dal.GetVacancyIDPerVacancyHistory((int)id);
      ...
      var JobTitleid = _db.tblVacancies.Where(x => x.ID == VacancyID).Select(x => x.JobTitleID).FirstOrDefault();
            ...
            //===================================================
            VacancySalaryModel vacancySalary = _dal.getVacancySalary(id);
      if (msg != null)
      {
        ViewBag.ErrorMessage = "You must select one of the Question Banks provided!";
      }
